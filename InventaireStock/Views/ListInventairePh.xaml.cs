...
namespace InventaireStock.Views
{
    ...
    public partial class ListInventairePh : ContentPage
    {
        ...
        {
            //on faire cette valeur sur false car le compilateur compile la méthode ListInventairePh_ItemSelected la premiére méthode et si on a exécute la méthode OnDisappearing la valeur close sera true et il ne va pas exécute la méthode ListInventairePh_ItemSelected  donc on initialise close avec false.
            InitializeComponent();
